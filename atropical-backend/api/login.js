...
export default async function handler(req, res) {
  ...
  try {
    ...
    // OPTITRAVEL_NOT_CONFIGURED (ainda não temos credenciais reais) ou a
    // reserva não existir dão sempre a mesma resposta genérica — quem nos
    // chama (app web/nativa) decide se quer cair para os dados de exemplo
    // neste caso específico (ver loginToBackend nas apps).
